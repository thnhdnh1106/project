                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-lg-6 d-md-flex align-items-center order-2 order-lg-1">
                            <div class="p-3 p-lg-5">
                                <img src="../assets/images/image-mini/forgot-pass.svg" alt="">
                            </div>
                            <!-- Divider -->
                        ...
                        <div class="col-lg-6 order-1">
                            <div class="p-4 p-sm-7">
                                <!-- Logo -->
                                <a href="index.html">
                                    <img class="mb-4 h-50px" src="../assets/images/image-mini/logo-icon.svg" alt="logo">
                                </a>
                                <!-- Title -->
                                ...
                                <form class="mt-sm-4">
                                    ...
                                    <div class="d-sm-flex justify-content-between small mb-4">
                                        ...
                                        <a href="#" class="btn btn-sm btn-link p-0 text-decoration-underline mb-0">Click
                                            to resend</a>
                                    </div>
                                    ...
                                    <div class="text-primary-hover mt-3 text-center"> Copyrights ©2023 Booking. Build by
                                        <a href="https://www.webestica.com/" class="text-body">Cao Thanh Danh</a>.
                                    </div>
                                </form>
                                <!-- Form END -->
                            </div>
