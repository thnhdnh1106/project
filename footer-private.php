<div class="container">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3">
            <!-- logo -->
            <a href="index.html">
                <img class="h-40px" src="../assets/images/image-header/logo-light.svg" alt="logo">
            </a>
            ...
            <p class="mb-2"><a href="#" class="text-body-secondary text-primary-hover"><i
                        class="fa-solid fa-phone me-2"></i>+1234 568 963</a> </p>
            <p class="mb-0"><a href="#" class="text-body-secondary text-primary-hover"><i
                        class="fa-regular fa-envelope me-2"></i>example@gmail.com</a></p>
        </div>
        <!-- Widget 1 END -->
    ...
    <div class="row g-4 justify-content-between mt-0 mt-md-2">
        ...
        <div class="col-sm-7 col-md-6 col-lg-4">
            ...
            <ul class="list-inline mb-0 mt-3">
                <li class="list-inline-item"> <a href="#"><img src="../assets/images/image-mini/paypal.svg"
                            class="h-30px" alt=""></a></li>
                <li class="list-inline-item"> <a href="#"><img src="../assets/images/image-mini/visa.svg" class="h-30px"
                            alt=""></a></li>
                <li class="list-inline-item"> <a href="#"><img src="../assets/images/image-mini/mastercard.svg"
                            class="h-30px" alt=""></a></li>
                <li class="list-inline-item"> <a href="#"><img src="../assets/images/image-mini/expresscard.svg"
                            class="h-30px" alt=""></a></li>
            </ul>
        </div>
        ...
        <div class="container">
            <div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-lg-start">
                ...
                <div class="text-body-secondary text-primary-hover"> Copyrights ©2023 Booking. Build by <a
                        href="https://www.webestica.com/" class="text-body-secondary">Cao Thành Danh</a>. </div>
                <!-- copyright links-->
