                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="listingMenu">
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu" data-bs-popper="none">
                                    <li> <a class="dropdown-item" href="index.php">Hotel Home</a></li>
                                    ...
                                    <li> <a class="dropdown-item" href="./hotel-list/index.php">Hotel List</a></li>
                            ...
                            <li> <a class="dropdown-item" href="./comfirm/comfirm.php">Booking Confirmed</a></li>
                            <li> <a class="dropdown-item" href="./comfirm/compare.php">Compare Listing</a></li>
                            <li> <a class="dropdown-item" href="./comfirm/offer.php">Offer Detail</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                            ...
                            <li> <a class="dropdown-item" href="./pages/group.php">Our Team</a></li>

                            <!-- Dropdown submenu -->
                            <li class="dropdown-submenu dropend">
                                <a class="dropdown-item dropdown-toggle" href="#">Authentication</a>
                                <ul class="dropdown-menu" data-bs-popper="none">
                                    <li> <a class="dropdown-item" href="./authentication/sign-in.php">Sign In</a>
                                    </li>
                                    <li> <a class="dropdown-item" href="./authentication/sign-up.php">Sign Up</a>
                                    </li>
                                    <li> <a class="dropdown-item" href="./authentication/f-pass.php">Forgot Password</a>
                                    </li>
                        ...
                        <ul class="dropdown-menu min-w-auto" data-bs-popper="none">
                            <li>
                                <a class="dropdown-item" href="https://support.webestica.com/" target="_blank">
                                    <i class="text-warning fa-regular fa-life-ring fa-fw me-2"></i>Support
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="docs/index.html" target="_blank">
                                    <i class="text-danger fa-fw fa-regular fa-newspaper me-2"></i>Documentation
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="dropdown-item" href="https://booking.webestica.com/rtl/" target="_blank">
                                    <i class="text-info fa-fw fa-solid fa-toggle-off me-2"></i>RTL demo
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="https://themes.getbootstrap.com/store/webestica/"
                                    target="_blank">
                                    <i class="text-success fa-fw fa-solid fa-cloud-arrow-down me-2"></i>Buy Booking!
                                </a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            ...
                            <li>
                                <a class="dropdown-item" href="docs/alerts.html" target="_blank">
                                    <i class="text-orange fa-fw fa-solid fa-puzzle-piece me-2"></i>Components
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                ...
                <li class="nav-item ms-3 dropdown">
                    ...
                    <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button"
                        ...
                        aria-expanded="false">
                        <img class="avatar-img rounded-2" src="./assets/images/image-header/01.jpg" alt="avatar">
                    </a>
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                        ...
                        <li><a class="dropdown-item" href="#"><i class="fa-regular fa-bookmark fa-fw me-2"></i>My
                                Bookings</a></li>
                        <li><a class="dropdown-item" href="#"><i class="fa-regular fa-heart fa-fw me-2"></i>My
                                Wishlist</a></li>
                        <li><a class="dropdown-item" href="#"><i class="fa-solid fa-gear fa-fw me-2"></i>Settings</a>
                        </li>
                        <li><a class="dropdown-item" href="#"><i class="fa-solid fa-circle-info fa-fw me-2"></i>Help
                                Center</a></li>
...
<div id="sticky-space" class="" style="height: 80px;"></div>