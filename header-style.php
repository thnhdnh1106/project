        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbarCollapse">
                <ul class="navbar-nav navbar-nav-scroll">
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu" data-bs-popper="none">
                                    ...
                                    <li> <a class="dropdown-item" href="hero-multiple-search.html">Hero Multiple
                                            Search</a></li>
                                    <li> <a class="dropdown-item" href="hero-image-gallery.html">Hero Image Gallery</a>
                                    </li>
                    ...
                    <!-- Nav item Account -->
                    <li class="nav-item dropdown">
                        <a class="nav-link " href="./userprofile/profile.php" id="accounntMenu">Accounts</a>
            </div>
            <!-- Main navbar END -->
            ...
            <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                ...
                <li class="nav-item ms-3 dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                        ...
                        <li><a class="dropdown-item" href="#"><i class="bi bi-info-circle fa-fw me-2"></i>Help
                                Center</a></li>
                        <li><a class="dropdown-item bg-danger-soft-hover" href="../authentication/logout.php"><i
                ...
                <li class="nav-item ms-3 d-none d-sm-block">
                    <a class="btn btn-sm btn-primary-soft mb-0" href="#"><i class="bi bi-lightning-charge"></i> Upgrade
                        now</a>
                </li>
            </ul>
            <!-- Profile and Notification START -->
