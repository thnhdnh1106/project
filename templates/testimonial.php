                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-md-6 col-lg-5 position-relative">
                                    ...
                                    <div class="position-absolute top-0 start-0 translate-middle z-index-9 mt-7 ms-4">
                                        <img src="./assets/images/image-mini/02 (1).svg"
                                    ...
                                    <!-- Image -->
                                    <img src="./assets/images/image-proof/01.jpg" class="rounded-3 position-relative"
                                        alt="">
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <!-- Content -->
                                    <h5 class="fw-light">Moonlight newspaper up its enjoyment agreeable depending. Timed
                                        voice share led him to widen noisy young. At weddings believed in laughing</h5>
                                    <!-- Rating -->
                        ...
                        <div class="px-4 px-md-5 ">
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-md-6 col-lg-5 position-relative">
                                    <!-- Element -->
                                    <div class="position-absolute top-0 start-0 translate-middle z-index-9 mt-7 ms-4">
                                        <img src="./assets/images/image-mini/03.svg"
                                            class="h-60px bg-orange rounded p-2" alt="">
                                    </div>
                                    ...
                                    <!-- Image -->
                                    <img src="./assets/images/image-proof/02.jpg" class="rounded-3 position-relative"
                                        alt="">
                                </div>
...
<script>
var swiper = new Swiper(".MYSwiper-mem", {
    slidesPerView: 1,
    spaceBetween: 30,
