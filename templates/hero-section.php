<div class="container">
    ...
    <div class="row g-4 g-lg-5">
        ...
        <div class="col-lg-6 position-relative mb-4 mb-md-0">
            ...
            <!-- Info -->
            <p class="mb-4">We bring you not only a stay option, but an experience in your budget to enjoy the luxury.
            </p>
            ...
            <div class="hstack gap-4 flex-wrap align-items-center">
                ...
                <a data-glightbox="" data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo"
                    ...
                    <div class="avatar avatar-md z-index-1 position-relative me-2">
                        <img class="avatar-img rounded-circle" src="./assets/images/image-body/12.jpg" alt="avatar">
                        <!-- Video button -->
                        <div
        ...
        <div class="col-lg-6 position-relative">
            ...
            <img src="./assets/images/image-body/06.jpg" class="rounded" alt="">
            ...
            <div class="vstack gap-5 align-items-center position-absolute top-0 start-0 d-none d-md-flex mt-4 ms-n3">
                <img class="icon-lg shadow-lg border border-3 border-white rounded-circle"
                    src="./assets/images/image-body/11.jpg" alt="avatar">
                <img class="icon-xl shadow-lg border border-3 border-white rounded-circle"
                    src="./assets/images/image-body/12 (1).jpg" alt="avatar">
            </div>
        </div>
    </div>
