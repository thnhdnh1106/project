<div class="container">
    <div class="row g-4 justify-content-between align-items-center">
        ...
        <div class="col-lg-5 position-relative">
            ...
            <!-- Image -->
            <img src="./assets/images/image-body/01 (1).jpg" class="rounded-3 position-relative" alt="">
            ...
            <div class="position-absolute bottom-0 start-0 z-index-1 mb-4 ms-5">
                <div class="bg-body d-flex d-inline-block rounded-3 position-relative p-3">
                    ...
                    <!-- Element -->
                    <img src="./assets/images/image-mini/01.svg"
                    ...
                    <div class="me-4">
                        ...
                        <ul class="avatar-group mb-0">
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle" src="./assets/images/image-mini/01.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle" src="./assets/images/image-mini/02.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle" src="./assets/images/image-mini/03.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle" src="./assets/images/image-mini/04.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
        ...
        <div class="col-lg-6">
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-6">
                    ...
                    <p class="mb-0">Departure defective arranging rapturous did. Conduct denied adding worthy little.
                    </p>
                </div>
                <!-- Item -->
                <div class="col-sm-6">
                ...
                <!-- Item -->
                <div class="col-sm-6">
                    <div class="icon-lg bg-info bg-opacity-10 text-info rounded-circle"><i class="fa-solid fa-bolt"></i>
                    </div>
